...
#
# Generated by Vivado on Tue Dec 15 11:35:11 CET 2020
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/homes/jmaier/adide/lab-exercises/click_lcm/solution/part_E_sync/part_E_sync.cache/compile_simlib/vcs"
  fi

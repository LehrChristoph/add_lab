...
#
# Generated by Vivado on Sat Dec 19 00:43:18 CET 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../part_E_sync.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../part_E_sync.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/julian/Dokumente/Studium/add/add_lab/lab2/template/part_E/sync/part_E_sync.cache/compile_simlib/vcs"
  fi
